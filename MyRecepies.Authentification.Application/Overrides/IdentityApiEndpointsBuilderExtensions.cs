...
{
    public static class IdentityApiEndpointsBuilderExtensions
    {
        ...
        public static IEndpointConventionBuilder MapIdentityApiFilterable<TUser>(this IEndpointRouteBuilder endpoints,
            IdentityApiEndpointsBuilderOptions configureOptions)
            where TUser : class, new()
        {
            ...
            if (configureOptions.IncludeLoginPost)
            {
            ...
            if (configureOptions.IncludeRefreshPost)
            {
            ...
            if (configureOptions.IncludeConfirmEmailGet)
            {
            ...
            if (configureOptions.IncludeResendConfirmationEmailPost)
            {
            ...
            if (configureOptions.IncludeForgotPasswordPost)
            {
            ...
            if (configureOptions.IncludeResetPasswordPost)
            {
            ...
            if (configureOptions.IncludeManageGroup)
            {
                var accountGroup = routeGroup.MapGroup("/manage").RequireAuthorization();

                if (configureOptions.Include2faPost)
                {
                ...
                if (configureOptions.IncludegInfoGet)
                {
                ...
                if (configureOptions.IncludeInfoPost)
                {
